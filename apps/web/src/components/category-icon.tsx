...
const PATHS: Record<string, string> = {
  ...
  // Una mano abierta con algo encima: dar, dibujado sin una iglesia ni un
  // símbolo religioso — el diezmo lo dan hogares de credos distintos.
  giving:
    'M3 13.5c1.5-1 3-1 4.5 0l2.5 2h3a1.5 1.5 0 0 1 0 3H12m-9-5V20m0-6.5 6.5 5.5H16l4.5-3.5a1.6 1.6 0 0 0-2-2.4M12 8.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z',
